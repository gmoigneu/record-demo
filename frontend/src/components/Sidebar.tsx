...
const Sidebar: React.FC<SidebarProps> = () => {
  return (
    <aside className="h-fit w-full flex flex-row sm:flex-col flex-wrap sm:w-2/5 lg:w-1/4 bottom-right-cut-corner">
      <section className="p-6 w-full border-0 border-upsun-yellow-400 bg-upsun-yellow-400">
        <div className="aside-title text-black flex flex-row gap-4 items-center mt-2">
